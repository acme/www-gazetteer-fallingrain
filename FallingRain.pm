...
sub find {
  ...
  if (not defined $countrycode) {
    ...
    if (not defined $countrycode) {
      croak("WWW::Gazetteer::FallingRain: Country $city / $country not found");
      return;
    }
  }
  ...
  my @urls;
  {
    ...
    @urls = (
      "$base_url$countrycode/a/" . $chars[0] . "/" . $chars[1] . "/" . $chars[2] . "/" . $chars[3] . "/" . $chars[4] . "/",
      "$base_url$countrycode/a/" . $chars[0] . "/" . $chars[1] . "/" . $chars[2] . "/" . $chars[3] . "/",
      "$base_url$countrycode/a/" . $chars[0] . "/" . $chars[1] . "/" . $chars[2] . "/",
  ...
  if (not $response->is_success) {
    croak("WWW::Gazetteer::FallingRain: City $city in $country not found");
    return;
  }
